/**
 * Validation rules for text inputs — PURE, widget-side. The RULE SET is the
 * input contract's (@wirework/widget-contracts); this is our implementation.
 ...
 */
import type { ValidationRule } from "@wirework/widget-contracts";
export type { ValidationRule } from "@wirework/widget-contracts";
