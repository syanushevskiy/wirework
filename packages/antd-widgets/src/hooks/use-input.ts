/** ALL antd-input logic lives here (guidelines: render-only components). */
...
import type { InputEvents } from "../widgets/antd-input";
...
export function useInput(
  ...
  /** Associates the visible label with the field. */
  const id = useId();
  ...
  return { id, value, valid: result.valid, message: result.message, change };
}
